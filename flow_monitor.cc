...
bmsce@bmsce-Precision-T1700:~/ns-allinone-3.29/ns-3.29$ ./waf --run scratch/flowWaf: Entering directory `/home/bmsce/ns-allinone-3.29/ns-3.29/build'
Waf: Leaving directory `/home/bmsce/ns-allinone-3.29/ns-3.29/build'
Build commands will be stored in build/compile_commands.json
'build' finished successfully (5.273s)
